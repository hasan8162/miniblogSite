...
<body>
  ...
  <div class="col-lg-2 btn-group">
    ...
    <div class="dropdown-menu">
      <a class="dropdown-item" href="{{ url('/dashboard') }}">Latest</a>
      <a class="dropdown-item" href="{{ url('/dashboard', 'Oldest') }}">Oldest</a>
      <a class="dropdown-item" href="{{ url('/dashboard', 'Popular') }}">Most Popular</a>
    </div>
  </div>
  </div>
    ...
    <div class = "Container mt-6 mr-5 ml-5">
        ...
        <div class="pt-3">
          <h4>Written by <a  href="{{ url('/dashboard/author', $post->user) }}" style="color: blue"> {{ $post->user->name }} </a>, {{ $post->created_at->format('d/m/Y') }}</h4>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            ...
            ?>  
              <li class="nav-item mr-3">
                <a type="submit" class="btn btn-outline-success" style="border-radius: 50%" href="{{ url('/dashboard/upvote', [$post->id, 'dashboard', $type]) }}">
                  <img src="{{ asset('images/uparrow.png') }}" width="20" height="20" alt="">
                </a>
              </li>
              <li class="nav-item">
                <a type="submit" class="btn btn-outline-danger" style="border-radius: 50%" href="{{ url('/dashboard/downvote',  [$post->id, 'dashboard', $type]) }}">
            ...
            ?>  
              <li class="nav-item mr-3">
                <a type="submit" class="btn btn-success" style="border-radius: 50%" href="{{ url('/dashboard/unvote',  [$post->id, 'dashboard', $type]) }}">
                  <img src="{{ asset('images/uparrow.png') }}" width="20" height="20" alt="">
                </a>
              </li>
              <li class="nav-item">
                <a type="submit" class="btn btn-outline-danger" style="border-radius: 50%" href="{{ url('/dashboard/upvotetodownvote',  [$post->id, 'dashboard', $type]) }}">
                  <img src="{{ asset('images/downarrow.png') }}" width="20" height="20" alt="">
                </a>
              </li>
            <?php
            ...
            ?>  
              <li class="nav-item mr-3">
                <a type="submit" class="btn btn-outline-success" style="border-radius: 50%" href="{{ url('/dashboard/downvotetoupvote',  [$post->id, 'dashboard', $type]) }}">
                  <img src="{{ asset('images/uparrow.png') }}" width="20" height="20" alt="">
                </a>
              </li>
              <li class="nav-item">
                <a type="submit" class="btn btn-danger" style="border-radius: 50%" href="{{ url('/dashboard/unvote',  [$post->id, 'dashboard', $type]) }}">
                  <img src="{{ asset('images/downarrow.png') }}" width="20" height="20" alt="">
                </a>
              </li>
            <?php
